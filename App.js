    ...
    return (
       <div className="header">
          <div className="nav-logo">
            <img src="https://logowik.com/content/uploads/images/swiggy2340.jpg" alt="swiggy-logo"/>
          </div>
...
const RestaurantCard = ({resData}) => {
  // console.log(resData)
  const {name, avgRating, areaName, cloudinaryImageId, cuisines, costForTwo} = resData?.info
